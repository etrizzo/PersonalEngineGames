...
class DebugRenderTask_Circle: public DebugRenderTask{
public:
	DebugRenderTask_Circle(Disc2 disc, bool dotted = false, float lifetime = 0.f, RGBA startColor = RGBA::WHITE, RGBA endColor = RGBA::WHITE, DebugRenderMode mode = DEBUG_RENDER_USE_DEPTH);
	void Render() override;
