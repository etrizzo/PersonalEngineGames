...
void Archer::Render()
{
	if (IsAlive()){
		...
		g_theRenderer->DrawTextAsSprite("Archer", m_worldPosition + Vector3(0.f, m_height * .9f, 0.f), Vector2::HALF, .2f, g_theGame->m_camera->GetRight(), UP, GetFactionColor(m_faction));
